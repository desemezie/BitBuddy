...
lightButton::lightButton(QWidget *parent)
    : QPushButton(parent), isLightOn(true) {
...
void lightButton::update(){
  if(isLightOn){
    ...
    emit themeChange("MainWindow { background-image: url(:/assets/black.jpeg); background-repeat: no-repeat; background-position: center; background-size: cover; }");
